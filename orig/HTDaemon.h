 ...
 */
void HTSendError PARAMS((int soc, int number, CONST char *msg));

extern void HTSendHeader PARAMS((int soc, HTFormat rep));
...
int HTLoadStrToStream PARAMS((HTStream * sink, CONST char *str));
int HTCloseStream PARAMS((HTStream * sink));
int HTCopyBodyToFile PARAMS((HTRequest * req, FILE *fp));
