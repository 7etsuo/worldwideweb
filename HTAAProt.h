...
The following three functioncs are called by the rule system
    : filename Protection setup files are cached by these functions.
      ...
      */
      PUBLIC void HTAA_setDefaultProtection PARAMS((HTRequest * req, CONST char *prot_filename, HTUidGid *eff_ids));
...
*/
PUBLIC void HTAA_setCurrentProtection PARAMS((HTRequest * req, CONST char *prot_filename, HTUidGid *eff_ids));
